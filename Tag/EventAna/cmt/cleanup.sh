...
${CMTROOT}/mgr/cmt cleanup -sh -pack=EventAna -version=v0 -path=/hpcfs/juno/junogpu/liuyan2016/cor-ana/Tag  $* >${cmtEventAnatempfile}
if test $? != 0 ; then
  echo >&2 "${CMTROOT}/mgr/cmt cleanup -sh -pack=EventAna -version=v0 -path=/hpcfs/juno/junogpu/liuyan2016/cor-ana/Tag  $* >${cmtEventAnatempfile}"
  cmtcleanupstatus=2

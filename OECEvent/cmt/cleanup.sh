...
${CMTROOT}/mgr/cmt cleanup -sh -pack=OECEvent -version=v0 -path=/hpcfs/juno/junogpu/liuyan2016/cor-ana  $* >${cmtOECEventtempfile}
if test $? != 0 ; then
  echo >&2 "${CMTROOT}/mgr/cmt cleanup -sh -pack=OECEvent -version=v0 -path=/hpcfs/juno/junogpu/liuyan2016/cor-ana  $* >${cmtOECEventtempfile}"
  cmtcleanupstatus=2

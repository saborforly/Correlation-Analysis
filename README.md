...
![](https://jupyter.ihep.ac.cn/uploads/upload_a36b7402a9924ee6048b57a53e066a8b.png)
### 系统环境
...
![](https://jupyter.ihep.ac.cn/uploads/upload_a55c6842ee146894a08c724712ca11c8.png)
* GlobalBuffer类主要负责的是全局缓存，主要包括两个链表：索引数据链表和窗口事例数据链表，各个线程都可以通过锁和状态量从全局缓存中获取数据和写入数据。在链表的实现中，为链表中的节点都设置了状态，状态的值代表着数据处理所处于的阶段
![](https://jupyter.ihep.ac.cn/uploads/upload_30069eeaa3c9133f01857f6c74c29152.png)
